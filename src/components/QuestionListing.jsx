...
function QuestionListing({ question, id, modalOpen, }) {
    ...
    return (
        <a onClick={() => {modalOpen(id)}} className={`group transition-all duration-500 ease-in-out flex flex-row w-9/12 justify-between cursor-pointer border-b-4 border p-3 rounded-xl bg-opacity-1
